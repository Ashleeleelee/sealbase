...
export default function App() {
  ...
  const handleViewDailySeal = (seal) => {
    setView("records");
    setSelected(seal);
  };
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'Noto Sans SC','PingFang SC',sans-serif", color: T.ink }}>
      ...
      <footer style={{ background: T.navy, padding: "22px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
